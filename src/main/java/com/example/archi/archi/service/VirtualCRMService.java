...
public class VirtualCRMService {
  ...
  public interface Iface {
    ...
    public java.util.List<VirtualLeadDTO> findLeads(double lowAnnualRevenue, double highAnnualRevenue) throws org.apache.thrift.TException;

    public java.util.List<VirtualLeadDTO> findLeadsByDate(java.lang.String startDate, java.lang.String endDate) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void findLeads(double lowAnnualRevenue, double highAnnualRevenue, org.apache.thrift.async.AsyncMethodCallback<java.util.List<VirtualLeadDTO>> resultHandler) throws org.apache.thrift.TException;

    public void findLeadsByDate(java.lang.String startDate, java.lang.String endDate, org.apache.thrift.async.AsyncMethodCallback<java.util.List<VirtualLeadDTO>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public java.util.List<VirtualLeadDTO> findLeads(double lowAnnualRevenue, double highAnnualRevenue) throws org.apache.thrift.TException
    {
      send_findLeads(lowAnnualRevenue, highAnnualRevenue);
      return recv_findLeads();
    }

    public void send_findLeads(double lowAnnualRevenue, double highAnnualRevenue) throws org.apache.thrift.TException
    {
    ...
    public java.util.List<VirtualLeadDTO> recv_findLeads() throws org.apache.thrift.TException
    {
    ...
    public java.util.List<VirtualLeadDTO> recv_findLeadsByDate() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void findLeads(double lowAnnualRevenue, double highAnnualRevenue, org.apache.thrift.async.AsyncMethodCallback<java.util.List<VirtualLeadDTO>> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      findLeads_call method_call = new findLeads_call(lowAnnualRevenue, highAnnualRevenue, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class findLeads_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<VirtualLeadDTO>> {
      private double lowAnnualRevenue;
      private double highAnnualRevenue;
      public findLeads_call(double lowAnnualRevenue, double highAnnualRevenue, org.apache.thrift.async.AsyncMethodCallback<java.util.List<VirtualLeadDTO>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      @Override
      public java.util.List<VirtualLeadDTO> getResult() throws org.apache.thrift.TException {
    ...
    public static class findLeadsByDate_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<VirtualLeadDTO>> {
      private java.lang.String startDate;
      private java.lang.String endDate;
      public findLeadsByDate_call(java.lang.String startDate, java.lang.String endDate, org.apache.thrift.async.AsyncMethodCallback<java.util.List<VirtualLeadDTO>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class findLeads<I extends Iface> extends org.apache.thrift.ProcessFunction<I, findLeads_args> {
      ...
      public findLeads_result getResult(I iface, findLeads_args args) throws org.apache.thrift.TException {
        findLeads_result result = new findLeads_result();
        result.success = iface.findLeads(args.lowAnnualRevenue, args.highAnnualRevenue);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class findLeads<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, findLeads_args, java.util.List<VirtualLeadDTO>> {
      public findLeads() {
        super("findLeads");
      }
      ...
      @Override
      public org.apache.thrift.async.AsyncMethodCallback<java.util.List<VirtualLeadDTO>> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<java.util.List<VirtualLeadDTO>>() { 
          @Override
          public void onComplete(java.util.List<VirtualLeadDTO> o) {
            findLeads_result result = new findLeads_result();
            result.success = o;
            try {
      ...
      @Override
      public void start(I iface, findLeads_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<VirtualLeadDTO>> resultHandler) throws org.apache.thrift.TException {
        iface.findLeads(args.lowAnnualRevenue, args.highAnnualRevenue,resultHandler);
      }
    }

    public static class findLeadsByDate<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, findLeadsByDate_args, java.util.List<VirtualLeadDTO>> {
      public findLeadsByDate() {
        super("findLeadsByDate");
      }
      ...
      @Override
      public void start(I iface, findLeadsByDate_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<VirtualLeadDTO>> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class findLeads_result implements org.apache.thrift.TBase<findLeads_result, findLeads_result._Fields>, java.io.Serializable, Cloneable, Comparable<findLeads_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.List<VirtualLeadDTO> success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, VirtualLeadDTO.class))));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public findLeads_result(
      java.util.List<VirtualLeadDTO> success)
    {
      this();
    ...
    public findLeads_result(findLeads_result other) {
      if (other.isSetSuccess()) {
        java.util.List<VirtualLeadDTO> __this__success = new java.util.ArrayList<VirtualLeadDTO>(other.success.size());
        for (VirtualLeadDTO other_element : other.success) {
          __this__success.add(new VirtualLeadDTO(other_element));
        }
    ...
    @org.apache.thrift.annotation.Nullable
    public java.util.Iterator<VirtualLeadDTO> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(VirtualLeadDTO elem) {
      if (this.success == null) {
        this.success = new java.util.ArrayList<VirtualLeadDTO>();
      }
      this.success.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.List<VirtualLeadDTO> getSuccess() {
      return this.success;
    }

    public findLeads_result setSuccess(@org.apache.thrift.annotation.Nullable java.util.List<VirtualLeadDTO> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((java.util.List<VirtualLeadDTO>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<VirtualLeadDTO>(_list0.size);
                  @org.apache.thrift.annotation.Nullable VirtualLeadDTO _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new VirtualLeadDTO();
                    _elem1.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, findLeads_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (VirtualLeadDTO _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (VirtualLeadDTO _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<VirtualLeadDTO>(_list5.size);
            @org.apache.thrift.annotation.Nullable VirtualLeadDTO _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new VirtualLeadDTO();
              _elem6.read(iprot);
  ...
  public static class findLeadsByDate_result implements org.apache.thrift.TBase<findLeadsByDate_result, findLeadsByDate_result._Fields>, java.io.Serializable, Cloneable, Comparable<findLeadsByDate_result>   {
    ...
    public findLeadsByDate_result setSuccess(@org.apache.thrift.annotation.Nullable java.util.List<VirtualLeadDTO> success) {
      this.success = success;
      return this;
    }
    ...
    private static class findLeadsByDate_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<findLeadsByDate_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<VirtualLeadDTO>(_list8.size);
                  @org.apache.thrift.annotation.Nullable VirtualLeadDTO _elem9;
                  for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                  {
                    _elem9 = new VirtualLeadDTO();
                    _elem9.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, findLeadsByDate_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (VirtualLeadDTO _iter11 : struct.success)
            {
              _iter11.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class findLeadsByDate_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<findLeadsByDate_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, findLeadsByDate_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (VirtualLeadDTO _iter12 : struct.success)
            {
              _iter12.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<VirtualLeadDTO>(_list13.size);
            @org.apache.thrift.annotation.Nullable VirtualLeadDTO _elem14;
            for (int _i15 = 0; _i15 < _list13.size; ++_i15)
            {
              _elem14 = new VirtualLeadDTO();
              _elem14.read(iprot);
